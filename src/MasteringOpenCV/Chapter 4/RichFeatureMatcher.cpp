...
{
	detector = new SurfFeatureDetector(10);
	extractor = new SurfDescriptorExtractor(48,16,true);
...
//void RichFeatureMatcher::MatchFeatures(const Mat& img_1, const Mat& img_1_orig, 
